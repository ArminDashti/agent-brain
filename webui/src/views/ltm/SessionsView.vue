  ...
  <div>
    <div class="flex flex-wrap items-end gap-3">
      <div>
        ...
        <p class="text-sm text-muted-foreground">Cursor sessions from state.vscdb (context %, tokens, mode)</p>
      </div>
        ...
        <tbody>
          ...
          <tr v-if="sessions.length === 0">
            <td colspan="5" class="px-3 py-8 text-center text-muted-foreground">
              No sessions yet. On Windows run: agent-brain-dispatcher sync
            </td>
          </tr>
        </tbody>
      </table>
